...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 19, 2019 at 04:58 PM
...
(2, 22, 'BSc. Software Engineering', 'A bachelor\'s degree, usually in computer science, computer systems engineering, software engineering or mathematics or completion of a college program in computer science is usually required.', 'Y'),
...
(4, 15, 'BBA', 'The Bachelor of Business Administration (BBA or B.B.A.) is a bachelor\'s degree in commerce and business administration. ... The BBA program usually includes general business courses and advanced courses for specific concentrations.', 'Y');
...
(8, 28, 2, 3, 'Artificial Intelligence', 'Artificial intelligence (AI) is the simulation of human intelligence processes by machines, especially computer systems. These processes include learning (the acquisition of information and rules for using the information)', 'CSY 3030', 'Y'),
(9, 24, 2, 2, 'Web Programming', 'Web programming refers to the writing, markup and coding involved in Web development, which includes Web content, Web client and server scripting and network security. The most common languages used for Web programming are XML, HTML, JavaScript, Perl 5 and PHP.', 'CSY 2028', 'Y'),
(10, 24, 2, 1, 'Web Development', 'Web development broadly refers to the tasks associated with developing websites for hosting via intranet or internet. The web development process includes web design, web content development', 'CSY 1018', 'Y'),
(11, 26, 2, 1, 'Software Engineering I', 'Software engineering is the process of analyzing user needs and designing, constructing, and testing end user applications that will satisfy these needs through the use of software programming languages.', 'CSY 1018', 'Y'),
(12, 29, 2, 2, 'Software Engineering II', 'Software engineering is the process of analyzing user needs and designing, constructing, and testing end user applications that will satisfy these needs through the use of software programming languages.', 'CSY 2030', 'Y'),
(13, 25, 2, 3, 'Software Engineering III', 'Software engineering is the process of analyzing user needs and designing, constructing, and testing end user applications that will satisfy these needs through the use of software programming languages.', 'CSY 3038', 'Y'),
(14, 30, 2, 2, 'Formal Specification of Software Systems', 'A formal software specification is a specification expressed in a language whose vocabulary, syntax and semantics are formally defined. This need for a formal definition means that the specification languages must be based on mathematical concepts whose properties are well understood.', 'CSY 2023', 'Y'),
(15, 25, 2, 2, 'Group Project', 'Group projects are an opportunity to work with others to explore your genetic heritage. They are usually focused on a common geographic origin, surname, or ethnic heritage. They may also be based on some other aspect of a paternal or maternal lineage.', 'CSY 2027', 'Y');
...
INSERT INTO `students` (`suid`, `cid`, `rstatus`, `rdormant`, `puid`, `slvid`) VALUES
(18, 2, 'Live', NULL, 25, 3),
(19, 3, 'Live', NULL, 16, 3),
(20, 4, 'Live', NULL, 16, 1),
(23, 2, 'Live', NULL, 22, 2);
...
(2, 'Diwas', '', 'Lamsal', '$2y$10$qM/lybXX23qsft73lPsF1OyChH291bidkQo8cWBMDJOCWdxg4Ldd.', 'Male', '1972-05-15', 'Kathmandu', '9824524242', 'lamsal.diwas@yahoo.com', 'Administrator', 'Y'),
(3, 'Ramesh', '', 'Thapa', '$2y$10$A/nyffEF61vB28ap/6ZoROA80Y/6/1vEoGurKdaiZELYQT9VKxcoe', 'Other', '1983-11-27', 'Lokanthali, Bhaktapur', '+977-9842351245', 'rameshthapa@wuc.edu.uk', 'Administrator', 'N'),
(5, 'Bish\'OW\'', 'Nath', 'Dhakal', '$2y$10$Y.W7wuJq01ZZ7ke1e3zSQODfyjl67jNdFLHjrKbkwMrLtYsgSADl6', 'Female', '2002-03-22', 'Boudha, Jorpati', '+9779841534534', 'bishownathdhakal@wcu.edu.uk', 'Administrator', 'Y'),
...
(7, 'Deepak', 'Kumar', 'Karna', '$2y$10$.zyDDMclUBIT4tGNUbg3ceozCxN/P9RNJjvtWnBIWPbiDaXsCtClG', 'Male', '1986-07-25', 'Ekantakuna, Lalitpur', '+9779842156151', 'dkarna@gmail.com', 'Administrator', 'Y'),
(15, 'Ramesh', 'Bahadur', 'Adhikari', '$2y$10$DKmIj.TVNA3NnMVshE/LBukdkptHwymKGeSjgBodSzJOxr6TT6uTG', 'Other', '2000-03-30', 'Kavre', '153245648', 'rameshadhikari@gmail.com', 'Module Leader', 'Y'),
...
(19, 'Ayush', 'Raj', 'Moktan', '$2y$10$8qpVXNgUJbwozjuRCugkC.oJdwutT6cEIej3kilWk26ApZm19f6Ca', 'Male', '1998-08-21', 'NAMI College, Jorpati', '9581651613', 'ayushmoktan@gmail.com', 'Student', 'Y'),
...
(22, 'Anita', '', 'Gurung', '$2y$10$5wtG5nZCYWpZ.mhC6nejQumDUAcx3mhMaS5jYB0jbEj3B7hTO7QQC', 'Female', '1969-09-24', 'New Baneshwor', '98161513215', 'anitagurun@nami.edu.np', 'Module Leader', 'Y'),
...
--
ALTER TABLE `users`
  MODIFY `uid` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
